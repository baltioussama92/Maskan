...
public class BookingController {
    ...
    @PutMapping("/{id}/pay")
    @PreAuthorize("hasAnyRole('GUEST','TENANT')")
    public ResponseEntity<PaymentCheckoutResponse> payReservation(@PathVariable String id,
                                                                  @AuthenticationPrincipal UserDetails principal) {
        return ResponseEntity.ok(paymentService.payEscrow(id, principal.getUsername()));
    }
